        ...
        var chartJmlHargaBeli = new Chart(document.getElementById('chartJmlHargaBeli').getContext('2d'), {
            type: 'line',
            data: {
                labels: ["Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des"],
                datasets: [{
                    label: 'Total Biaya Pembelian Bulanan (Juta)',
                    backgroundColor: 'rgba(255, 99, 132, 0)',
                    borderColor: 'rgb(255, 72, 5)',
                    pointHoverBorderWidth: 10,
                    pointBorderWidth: 5,
                    pointHitRadius: 10,
                    data: []
