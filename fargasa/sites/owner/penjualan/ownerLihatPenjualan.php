...
$_SESSION['subPage'] = "ownerLihatPenjualan";
...
?>
  ...
  <body>
    ...
    <div class="container mb-5 ">
      ...
      <table class="table table-striped table-hover table-bordered responsive-text table-responsive-md mb-5" id="dataPenjualan" style="">
